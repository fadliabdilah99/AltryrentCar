...
!(function (t) {
  function e(t, e, n) {
    return (
      "string" == typeof t &&
        ("%" == t.slice(-1) ? (t = (parseInt(t.substring(0, t.length - 1)) / 100) * e) : "vh" == t.slice(-2) ? (t = (parseInt(t.substring(0, t.length - 2)) / 100) * n) : "px" == t.slice(-2) && (t = parseInt(t.substring(0, t.length - 2)))),
      t
    );
  }
  var n = t(window),
